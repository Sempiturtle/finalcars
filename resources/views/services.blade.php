...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Our Services - AutoCheck Enterprises</title>
    ...
    <body class="antialiased bg-gray-50 text-gray-900 border-t-4 border-autocheck-red">
        ...
        <header class="bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm border-b border-gray-100" x-data="{ open: false }">
            <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="{{ route('services.index') }}" class="text-sm font-bold text-autocheck-red transition-colors">Services</a>
            ...
            <div x-show="open" class="md:hidden bg-white border-b border-gray-200 py-4 px-4 space-y-2">
                ...
                <a href="{{ route('services.index') }}" class="block px-4 py-2 text-base font-bold text-autocheck-red bg-red-50 rounded-lg">Services</a>
            ...
            <section class="bg-white py-20 border-b border-gray-100">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p class="text-xl text-gray-500 font-medium max-w-3xl mx-auto">
                        Each service is handled by skilled technicians using modern diagnostic tools.
                    </p>
                </div>
            </section>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-red-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-autocheck-red group-hover:rotate-12 transition-all duration-500">
                                <svg class="h-10 w-10 text-autocheck-red group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Preventive Maintenance Services</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Regular scheduled maintenance to keep your vehicle in optimal condition.</p>
                        </div>

                        <!-- Service 2: Engine Diagnostics -->
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-blue-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:-rotate-12 transition-all duration-500">
                                <svg class="h-10 w-10 text-blue-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Engine Diagnostics and Repair</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Advanced diagnostic tools to identify and fix engine issues accurately.</p>
                        </div>

                        <!-- Service 3: Electrical System -->
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-yellow-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-yellow-500 group-hover:scale-110 transition-all duration-500">
                                <svg class="h-10 w-10 text-yellow-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Electrical System Repair</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Complete electrical system diagnostics and repairs.</p>
                        </div>

                        <!-- Service 4: Brake and Suspension -->
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-green-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-green-600 group-hover:rotate-12 transition-all duration-500">
                                <svg class="h-10 w-10 text-green-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Brake and Suspension Inspection</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Safety-critical inspections and repairs for brakes and suspension.</p>
                        </div>

                        <!-- Service 5: Oil Change -->
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-orange-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-orange-600 group-hover:-translate-y-2 transition-all duration-500">
                                <svg class="h-10 w-10 text-orange-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96.808l-1.014 1.48a2 2 0 01-2.72.697l-4.43-2.558a2 2 0 01-.697-2.72l1.48-1.014a2 2 0 00.808-1.96l-.477-2.387a2 2 0 00-.547-1.022L7.05 4.05a2 2 0 00-2.828 0L2.212 6.06c-1.333 1.333-1.333 3.49 0 4.823l10.906 10.906c1.333 1.333 3.49 1.333 4.823 0l2.01-2.01a2 2 0 000-2.828l-1.523-1.523z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">Oil Change Services</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Quick and professional oil changes with quality products.</p>
                        </div>

                        <!-- Service 6: General Inspection -->
                        <div class="group bg-white rounded-[3rem] p-10 lg:p-12 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 flex flex-col items-center text-center">
                            <div class="w-20 h-20 bg-purple-50 rounded-[2rem] flex items-center justify-center mb-8 group-hover:bg-purple-600 group-hover:scale-90 transition-all duration-500">
                                <svg class="h-10 w-10 text-purple-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                            </div>
                            <h3 class="text-2xl font-black text-gray-900 mb-6 uppercase tracking-tight">General Automotive Inspection</h3>
                            <p class="text-lg text-gray-600 font-medium leading-relaxed">Comprehensive vehicle inspections and safety check-ups.</p>
                        </div>
                    </div>
                </div>
            </section>

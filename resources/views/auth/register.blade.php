        ...
        >
            ...
            <div class="text-center mb-3">
                <a href="/" class="inline-flex flex-col items-center space-y-1 mb-1">
                    <img src="{{ asset('images/logo.png') }}" alt="AutoCheck Logo" class="h-10 w-10 rounded-full object-cover border-2 border-blue-500 shadow-xl">
                    <span class="text-lg font-black tracking-tight text-gray-900 leading-none">AutoCheck</span>
                </a>
                <h2 class="text-[11px] font-bold text-gray-600 uppercase tracking-widest leading-none">Join the Fleet</h2>
                <p class="text-[9px] text-gray-400 mt-0.5">Create your account</p>
            </div>

            {{-- Card --}}
            <div class="bg-white rounded-[1.5rem] shadow-2xl shadow-blue-500/10 border border-gray-100 p-5 md:p-7">

                {{-- Step Indicator Dots --}}
                <div class="flex items-center justify-center gap-0 mb-3 px-4" x-show="!showSuccess">
                ...
                {{-- Progress Track --}}
                <div class="progress-track mb-5" x-show="!showSuccess">
                ...
                <div class="step-container" x-show="!showSuccess">
                    ...
                    <div class="step-panel"
                        ...
                        <div class="text-center mb-3">
                            <div class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 mb-1.5">
                                <svg class="w-3.5 h-3.5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            </div>
                            <h3 class="text-[10px] font-black text-gray-800 uppercase tracking-wider">Who are you?</h3>
                            <p class="text-[8px] text-gray-400 mt-0.5">Let's start with your name</p>
                        </div>
                        <div class="space-y-3 text-left">
                            <div class="grid grid-cols-2 gap-3 field-enter" :key="'s1-1-' + currentStep">
                                <div>
                                    <label class="block text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1 px-1">First Name</label>
                                    <input x-model="firstName"
                                           type="text"
                                           class="wizard-input w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-xl outline-none font-bold text-[11px]"
                                           placeholder="Juan"
                                           @keydown.enter="nextStep()">
                                    <p x-show="errors.firstName" x-text="errors.firstName" class="mt-0.5 text-[8px] font-bold text-red-500 px-1"></p>
                                </div>
                                <div>
                                    <label class="block text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1 px-1">Last Name</label>
                                    <input x-model="lastName"
                                           type="text"
                                           class="wizard-input w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-xl outline-none font-bold text-[11px]"
                                           placeholder="Dela Cruz"
                                           @keydown.enter="nextStep()">
                                    <p x-show="errors.lastName" x-text="errors.lastName" class="mt-0.5 text-[8px] font-bold text-red-500 px-1"></p>
                                </div>
                            </div>
                            <div class="field-enter" :key="'s1-2-' + currentStep">
                                <label class="block text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1 px-1">Username</label>
                                <input x-model="username"
                                       type="text"
                                       class="wizard-input w-full px-4 py-2.5 bg-gray-50 border border-gray-100 rounded-xl outline-none font-bold text-[11px]"
                                       placeholder="juandc123"
                                       @keydown.enter="nextStep()">
                                <p x-show="errors.username" x-text="errors.username" class="mt-0.5 text-[8px] font-bold text-red-500 px-1"></p>
                            </div>
                        </div>
                        <div class="pt-3">
                            <button @click="nextStep()" type="button"
                                    class="btn-next w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-xl shadow-blue-500/20 active:scale-95 transform flex items-center justify-center gap-2">
                                Continue
                    ...
                    <div class="step-panel"
                        ...
                        <div class="text-center mb-3">
                            <div class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-50 mb-1.5">
                                <svg class="w-3.5 h-3.5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                            </div>
                            <h3 class="text-[10px] font-black text-gray-800 uppercase tracking-wider">Secure Your Account</h3>
                            <p class="text-[8px] text-gray-400 mt-0.5">Set up your login credentials</p>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input x-model="password"
                                               ...
                                               class="wizard-input w-full pl-5 pr-12 py-3 bg-gray-50 border border-gray-100 rounded-2xl outline-none font-bold text-xs"
                                               placeholder="••••••••"
                                               @keydown.enter="nextStep()">
                    ...
                    <div class="step-panel"
                        ...
                        <div class="text-center mb-3">
                            <div class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-50 mb-1.5">
                                <svg class="w-3.5 h-3.5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            </div>
                            <h3 class="text-[10px] font-black text-gray-800 uppercase tracking-wider">Almost Done!</h3>
                            <p class="text-[8px] text-gray-400 mt-0.5">Add your contact number</p>
                        </div>
                        <div class="space-y-4 text-left">
                ...
                {{-- Sign In Link --}}
                <div class="mt-4 text-center border-t border-gray-50 pt-4" x-show="!showSuccess">
                    <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">
                        Got an account?

        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-9 space-y-6">
                ...
                <div x-show="activeTab === 'security'" 
                     ...
                     class="bg-gray-900 p-6 rounded-2xl border border-white/5 shadow-xl space-y-8 animate-fade-in relative overflow-hidden">
                    ...
                    <form action="{{ route('customer.profile.password') }}" method="POST" class="relative z-10 space-y-4 max-w-lg">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="current_password" required class="w-full pl-4 pr-12 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white font-bold text-xs focus:ring-2 focus:ring-autocheck-red/20 focus:border-autocheck-red transition-all">
                                <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors z-10">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="password" required class="w-full pl-4 pr-12 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white font-bold text-xs focus:ring-2 focus:ring-autocheck-red/20 focus:border-autocheck-red transition-all">
                            </div>
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-[9px] font-black text-gray-500 uppercase tracking-widest ml-1 italic">Verify Password</label>
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" required class="w-full pl-4 pr-12 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white font-bold text-xs focus:ring-2 focus:ring-autocheck-red/20 focus:border-autocheck-red transition-all">
                            </div>
                        </div>

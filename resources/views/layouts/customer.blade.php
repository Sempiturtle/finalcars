        ...
        >
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('customer.profile.index') }}" class="sidebar-item flex items-center px-4 py-3.5 rounded-2xl text-sm font-bold {{ request()->routeIs('customer.profile.*') ? 'active' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900' }}">

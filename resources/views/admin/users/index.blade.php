                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end space-x-1.5">
                                        ...
                                        <form action="{{ route('admin.users.destroy', $user) }}" method="POST" class="inline" id="del-user-{{ $user->id }}">
                                            ...
                                            <button
                                                type="button"
                                                onclick="confirmDelete(this.closest('form'), 'This will permanently archive the admin account and revoke all access. This action cannot be undone.', 'Archive User', 'Yes, Archive')"
                    ...
                    <div class="p-8">
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1 col-span-2"><label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Role</label><select name="role" required class="w-full px-5 py-3.5 bg-gray-50 border-transparent rounded-xl text-sm font-bold focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all"><option value="admin">🔒 Admin</option><option value="customer">👤 Customer</option></select></div>
                    ...
                    <div class="p-8">
                        ...
                        <form :action="'/admin/users/' + editUser.id" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1 col-span-2"><label class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Role</label><input type="hidden" name="role" :value="editUser.role"><select disabled x-model="editUser.role" class="w-full px-5 py-3.5 bg-gray-50 border-transparent rounded-xl text-sm font-bold focus:bg-white focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all cursor-not-allowed opacity-75"><option value="admin">🔒 Admin</option><option value="customer">👤 Customer</option></select></div>

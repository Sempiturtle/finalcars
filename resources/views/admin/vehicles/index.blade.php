                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/50 border-b border-gray-100">
                                ...
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Owner</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Plate Number</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-right">Total Cost</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Registered</th>
                                ...
                                <tr class="group hover:bg-gray-50/30 transition-all duration-300">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex flex-col items-center">
                                            <span class="text-[11px] font-black text-gray-900 tracking-wider">{{ $vehicle->registration_date?->format('M d, Y') ?? 'N/A' }}</span>
                                            <span class="text-[8px] font-black text-gray-400 uppercase tracking-widest mt-0.5">Registration</span>
                                        </div>
                                    </td>

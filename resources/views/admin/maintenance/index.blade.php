<x-admin-layout>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-black text-gray-900 tracking-tight">Maintenance <span class="text-autocheck-red">Schedule</span></h1>
                <p class="text-[13px] text-gray-500 mt-0.5 font-medium">Monitor and manage your fleet's regular service appointments.</p>
            </div>
        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div class="space-y-4 overflow-y-auto max-h-[600px] pr-2 custom-scrollbar">
                        @foreach($schedules as $schedule)
                            <div class="group relative bg-gray-50 rounded-2xl p-4 transition-all hover:bg-white hover:shadow-xl hover:shadow-gray-200/50 border border-transparent hover:border-gray-100">
                                ...
                                <h3 class="text-sm font-bold text-gray-900 group-hover:text-autocheck-red transition-colors">{{ $schedule['description'] }}</h3>
                                <p class="text-xs text-gray-500 font-medium mb-3">{{ $schedule['make_model'] }} ({{ $schedule['plate_number'] }})</p>

                                <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                    <div class="flex items-center text-xs font-bold text-gray-900">
                                        <svg class="h-3.5 w-3.5 mr-2 text-autocheck-red" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
